...
// Toda vez que eu pegar um classe/interface (nesse caso Database), o apelido que vou dar é
// "Database" e toda vez que eu precisar dessa classe/interface com apelido de Database, injete
// minha interface MySQLDatabase
