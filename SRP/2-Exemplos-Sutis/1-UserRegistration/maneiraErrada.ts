// Está errado porque o DTO está sendo usado tanto para criar o usuário quanto para buscar o usuário,
// o DTO tem razões diferentes para mudar, assim quebrando o SRP
